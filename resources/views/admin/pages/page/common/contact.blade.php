...
@section('title', 'Customize ContactPage - Car Image Editing')
        ...
        <div class="content container-fluid">
                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Customize ContactPage</li>
                            </ol>
                        </nav>

                        <h1 class="page-header-title">Customize ContactPage</h1>
                    </div>
                </div>
                <!-- End Row -->
            </div>
            ...
            <div class="row">
                            ...
                            <ul id="navbarSettings" class="js-sticky-block js-scrollspy navbar-nav navbar-nav-lg nav-tabs card card-navbar-nav"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="#aboutSection">
                                        <i class="tio-online nav-icon"></i> Contact Section
                                    </a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="col-lg-9">
                    <!-- About section -->
                    <div id="aboutSection">
                        @include('admin.components.page.contact.contact-section')
                    </div>
                    <!-- End about section -->

                    <!-- Card -->
                    <div id="seoMetaSection">
                        @include('admin.components.page.contact.seo-meta-section')
                    </div>
                    <!-- End Card -->
