...
@section('title', 'SEO Settings - Car Image Edit')
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">SEO Meta Settings</h1>
                    </div>
                </div>
                <!-- End Row -->
            </div>
            ...
            <div class="row">
                    ...
                    <div class="navbar-vertical navbar-expand-lg mb-3 mb-lg-5">
                        ...
                        <div id="navbarVerticalNavMenu" class="collapse navbar-collapse">
                            ...
                            <ul id="navbarSettings" class="js-sticky-block js-scrollspy navbar-nav navbar-nav-lg nav-tabs card card-navbar-nav"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('settings.seo') }}">
                ...
                <div class="col-lg-9">
                    <!-- Card -->
                    <div id="seoSection">
                        @include('admin.components.settings.seo')
                    </div>
                    <!-- End Card -->
