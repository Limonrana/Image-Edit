...
@section('title', 'Orders Cancelled Request - Car Image Editing')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title">Orders Cancelled Request <span class="badge badge-soft-dark ml-2">{{ count($orders) }}</span></h1>
                </div>
            </div>
            <!-- End Row -->
        </div>
