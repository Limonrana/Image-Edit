...
@section('title', 'Add New Project - Car Image Editing')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">Add New Project</h1>
                </div>
            </div>
            <!-- End Row -->
        </div>
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" placeholder="eg. WEB LANDING PAGE" value="{{ old('title') }}">
                                @error('title')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-light @error('slug') is-invalid @enderror" name="slug" id="slug" placeholder="eg. web-landing-page" value="{{ old('slug') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('client_name') is-invalid @enderror" name="client_name" id="client" placeholder="eg. Givson Artboard, New York, USA" value="{{ old('client_name') }}">
                                @error('client_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="js-tagify tagify-form-control form-control @error('tools_used') is-invalid @enderror" name="tools_used" id="tools_used" placeholder="Enter used tools name" value="{{ old('tools_used') }}">
                                @error('tools_used')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div id="creating_date" class="js-flatpickr flatpickr-custom input-group input-group-merge "
                                    ...
                                    <input type="text" class="flatpickr-custom-form-control form-control @error('creating_date') is-invalid @enderror" id="creating_date_label" placeholder="Select project creation date" name="creating_date" data-input value="{{ old('creating_date') }}">
                                </div>
                                @error('creating_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
