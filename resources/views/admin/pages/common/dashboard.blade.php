            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="#">
                        <i class="tio-user-add mr-1"></i> View Reports
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush list-group-no-gutters">
                            ...
                            <li class="list-group-item py-3">
                                <div class="media">
                                    <div class="mt-1 mr-3">
                                        <img class="avatar avatar-xs avatar-4by3" src="{{ asset('assets/svg/brands/capsule.svg') }}" alt="Image Description">
                                    </div>
                            ...
                            <li class="list-group-item py-3">
                                <div class="media">
                                    <div class="mt-1 mr-3">
                                        <img class="avatar avatar-xs avatar-4by3" src="{{ asset('assets/svg/brands/mailchimp.svg') }}" alt="Image Description">
                                    </div>
                                    <div class="media-body">
                                        <div class="row align-items-center">
                                            <div class="col">
