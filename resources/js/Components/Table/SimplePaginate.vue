            ...
            <ul class="pagination">
                <template v-for="link in links">
                    <li v-if="link.label === 'Next &raquo;' || link.label === '&laquo; Previous'">
                        <inertia-link class="pagination__link" :href="link.url" v-if="link.url !== null">
                    ...
                    <li v-else>
                        <inertia-link :href="link.url" class="pagination__link" :class="{ 'pagination__link--active' : link.active }">{{ link.label }}</inertia-link>
                    </li>
                </template>
            </ul>
        </div>
