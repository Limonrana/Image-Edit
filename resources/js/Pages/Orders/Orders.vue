    ...
    <div class="orders">
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                <button class="btn btn-primary shadow-md mr-2">Create New Order</button>
            </div>
        </div>
                        ...
                        <div class="table-report table-report--tabulator tabulator">
                            <custom-table>
                                ...
                                <template #tbody>
                                    ...
                                    <table-item id="6" date="Aug 25, 2020" total="232" :is-paid="true" :status="0">#ORD-128736</table-item>
                                    <table-item id="7" date="Aug 25, 2020" total="232" :is-paid="true" :status="0">#ORD-128736</table-item>
                                    <table-item id="8" date="Aug 25, 2020" total="232" :is-paid="true" :status="0">#ORD-128736</table-item>
                                    <table-item id="9" date="Aug 25, 2020" total="232" :is-paid="true" :status="0">#ORD-128736</table-item>
                                    <table-item id="10" date="Aug 25, 2020" total="232" :is-paid="true" :status="0">#ORD-128736</table-item>
                                </template>
                                <template #paginate>
